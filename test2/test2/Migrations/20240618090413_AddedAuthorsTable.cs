        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPublishingHouse = table.Column<int>(type: "int", nullable: false),
                    PublishingHouseIdPublishingHouse = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Books", x => x.IdBook);
                    table.ForeignKey(
                        name: "FK_Books_PublishingHouses_PublishingHouseIdPublishingHouse",
                        column: x => x.PublishingHouseIdPublishingHouse,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_PublishingHouseIdPublishingHouse",
                table: "Books",
                column: "PublishingHouseIdPublishingHouse");
        }
